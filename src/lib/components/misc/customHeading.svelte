...
>
	<div bind:this={element} id={anchorId} class="group relative">
		...
		{#if style === 'h1'}
			<h1 class=" flex w-full items-center gap-x-3 ">
				<a
					href="#{anchorId}"
		...
		{:else if style === 'h2'}
			<h2 class=" flex w-full items-center gap-x-3 ">
				<a
					href="#{anchorId}"
					class=" no-underline opacity-0 group-hover:opacity-100 absolute text-lg -left-6 focus:opacity-100 transition-opacity duration-500"
				>
		...
		{:else if style === 'h3'}
			<h3 class=" flex w-full items-center gap-x-3 ">
				<a
					href="#{anchorId}"
					class=" no-underline opacity-0 group-hover:opacity-100 absolute text-lg -left-6 focus:opacity-100 transition-opacity duration-500"
				>
		...
		{:else if style === 'h4'}
			<h4 class=" flex w-full items-center gap-x-3 ">
				<a
					href="#{anchorId}"
					class=" no-underline opacity-0 group-hover:opacity-100 absolute text-lg -left-6 focus:opacity-100 transition-opacity duration-500"
				>
		...
		{:else if style === 'h5'}
			<h5 class=" flex w-full items-center gap-x-3 ">
				<a
					href="#{anchorId}"
					class=" no-underline opacity-0 group-hover:opacity-100 absolute text-lg -left-6 focus:opacity-100 transition-opacity duration-500"
				>
		...
		{:else}
			<h6 class=" flex w-full items-center gap-x-3 ">
				<a
					href="#{anchorId}"
					class=" no-underline opacity-0 group-hover:opacity-100 absolute text-lg -left-6 focus:opacity-100 transition-opacity duration-500"
				>
