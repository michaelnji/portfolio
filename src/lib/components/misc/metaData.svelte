...
<div class="w-full max-w-sm md:max-w-xl grid grid-cols-2 md:grid-cols-3 gap-3">
	...
	<div
		class=" p-4 xl:hover:!bg-primary   cursor-pointer relative overflow-hidden flex items-center justify-center  card-wrapper dark:bg-gray-900 boder-gray dark:border-gray-700 border-2 border-black gap-x-1 font-semibold text-lg transition duration-300"
		role="button"
		tabindex="0"
		on:keydown
