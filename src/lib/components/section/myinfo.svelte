...
<OutlineLayered />
<div class=" md:p-12 p-3 py-14 bg-primary grid grid-cols-1 place-items-center">
	...
	<div bind:this={el}></div>
		<div
			class="bg-gray-50 p-6 border-4 border-black card-wrapper max-w-2xl grid gap-6 relative myinfo" style="opacity: 0; transform:translateY(100px)"
		>
			<div
			...
			<div class=" space-y-6">
				...
				<div class="w-full flex flex-wrap gap-3">
					...
					<div class="rounded-xl flex-1 bg-yellow-300 text-yellow-950 p-6 space-y-2">
						<CommandLine size="40" />
						<h2 class="font-head text-5xl font-bold">
							{numToSummary(userInfo.totalCommitCounts)}
						</h2>
						<span>COMMITS</span>
					</div>
				</div>
